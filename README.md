...
- **标准玩法** —— 双方各执十五枚暗子，翻开的永远是自己人，暗子只知道格位、不知道身份；
- **混斗玩法** —— 红黑 30 枚棋子混洗成一池、逐格背面朝上。**己方半场的暗子暂时归你**（可以走、可以吃），
  但翻开若是敌方棋子，**该子当场易主**：它停在落点上，从那一刻起由对方使用。
...
pnpm test                         # 95 条规则、AI、混斗、吃子提示与托盘单测
...
- **两种玩法**：标准揭棋 / **混斗**（M1–M5，红黑混洗、半场归属、翻开易主、反将自身由「禁止立即吃将」缓冲）
- **禁止循环追棋**：同一局面最多出现两次，第三次重现即禁止，被将军的一方不受此限；全堵死时按**困毙判负**
